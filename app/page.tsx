              ...
              return (
                ...
                >
                  <Link href={feature.href} className="block group h-full">
                    <div className="relative h-full bg-white dark:bg-gray-800 rounded-[3rem] p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-[1.02]">
                      {/* Decorative Border - Connected at edges, gap in middle */}
                      {/* Top border - left part */}
                      <div className="absolute top-0 left-0 h-[3px] bg-emerald-500 dark:bg-emerald-400 group-hover:bg-emerald-600 dark:group-hover:bg-emerald-300 transition-colors" style={{ width: '35%', borderRadius: '9999px', borderTopLeftRadius: '6rem', borderTopRightRadius: '3rem' }}></div>
                      {/* Top border - right part */}
                      <div className="absolute top-0 right-0 h-[3px] bg-emerald-500 dark:bg-emerald-400 group-hover:bg-emerald-600 dark:group-hover:bg-emerald-300 transition-colors" style={{ width: '35%', borderRadius: '9999px', borderTopRightRadius: '6rem', borderTopLeftRadius: '3rem' }}></div>
                      {/* Bottom border - left part */}
                      <div className="absolute bottom-0 left-0 h-[3px] bg-emerald-500 dark:bg-emerald-400 group-hover:bg-emerald-600 dark:group-hover:bg-emerald-300 transition-colors" style={{ width: '35%', borderRadius: '9999px', borderBottomLeftRadius: '6rem', borderBottomRightRadius: '3rem' }}></div>
                      {/* Bottom border - right part */}
                      <div className="absolute bottom-0 right-0 h-[3px] bg-emerald-500 dark:bg-emerald-400 group-hover:bg-emerald-600 dark:group-hover:bg-emerald-300 transition-colors" style={{ width: '35%', borderRadius: '9999px', borderBottomRightRadius: '6rem', borderBottomLeftRadius: '3rem' }}></div>
                      {/* Left border - top part */}
                      <div className="absolute top-0 left-0 w-[3px] bg-emerald-500 dark:bg-emerald-400 group-hover:bg-emerald-600 dark:group-hover:bg-emerald-300 transition-colors" style={{ height: '35%', borderRadius: '9999px', borderTopLeftRadius: '6rem', borderBottomLeftRadius: '3rem' }}></div>
                      {/* Left border - bottom part */}
                      <div className="absolute bottom-0 left-0 w-[3px] bg-emerald-500 dark:bg-emerald-400 group-hover:bg-emerald-600 dark:group-hover:bg-emerald-300 transition-colors" style={{ height: '35%', borderRadius: '9999px', borderBottomLeftRadius: '6rem', borderTopLeftRadius: '3rem' }}></div>
                      {/* Right border - top part */}
                      <div className="absolute top-0 right-0 w-[3px] bg-emerald-500 dark:bg-emerald-400 group-hover:bg-emerald-600 dark:group-hover:bg-emerald-300 transition-colors" style={{ height: '35%', borderRadius: '9999px', borderTopRightRadius: '6rem', borderBottomRightRadius: '3rem' }}></div>
                      {/* Right border - bottom part */}
                      <div className="absolute bottom-0 right-0 w-[3px] bg-emerald-500 dark:bg-emerald-400 group-hover:bg-emerald-600 dark:group-hover:bg-emerald-300 transition-colors" style={{ height: '35%', borderRadius: '9999px', borderBottomRightRadius: '6rem', borderTopRightRadius: '3rem' }}></div>
                      ...
                      <div className="mb-6 flex justify-center">
                        <div className="relative">
                          ...
                          <div className="relative w-16 h-16 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-500 dark:from-emerald-400 dark:to-teal-400 flex items-center justify-center shadow-lg group-hover:shadow-emerald-500/50 transition-all">
                      ...
                      <div className="text-center">
                        ...
                        <div className="flex justify-center">
                          <div className="w-10 h-10 rounded-full bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center group-hover:bg-emerald-500 dark:group-hover:bg-emerald-400 transition-all">
                            <ArrowRight className="h-5 w-5 text-emerald-600 dark:text-emerald-400 group-hover:text-white group-hover:translate-x-[-4px] rtl:group-hover:translate-x-[4px] transition-all" />
                          </div>
                        </div>
                      </div>
                    </div>
