import { Surah, SurahWithAyahs, Ayah } from "@/types";
...
export const surahs: Surah[] = [
  ...
  { number: 56, name: "الواقعة", englishName: "Al-Waaqia", englishNameTranslation: "The Event", numberOfAyahs: 96, revelationType: "Meccan" },
  ...
  { number: 63, name: "المنافقون", englishName: "Al-Munaafiqoon", englishNameTranslation: "The Hypocrites", numberOfAyahs: 12, revelationType: "Medinan" },
  ...
  { number: 86, name: "الطارق", englishName: "At-Taariq", englishNameTranslation: "The Night-Comer", numberOfAyahs: 17, revelationType: "Meccan" },
  ...
  { number: 91, name: "الشمس", englishName: "Ash-Shams", englishNameTranslation: "The Sun", numberOfAyahs: 21, revelationType: "Meccan" },
  ...
  { number: 100, name: "العاديات", englishName: "Al-Aadiyaat", englishNameTranslation: "Those that run", numberOfAyahs: 11, revelationType: "Meccan" },
  ...
  { number: 102, name: "التكاثر", englishName: "At-Takaathur", englishNameTranslation: "The Piling Up", numberOfAyahs: 8, revelationType: "Meccan" },
  ...
  { number: 114, name: "الناس", englishName: "An-Naas", englishNameTranslation: "The Mankind", numberOfAyahs: 6, revelationType: "Meccan" },
];

// دالة لجلب بيانات السورة من API
export async function fetchSurah(surahNumber: number): Promise<SurahWithAyahs | null> {
  try {
